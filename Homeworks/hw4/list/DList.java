...
public class DList {
  ...
  public static void main(String[] args) {
    ...
    if (l.front().item != 9) {
      System.out.println("front.item is wrong.");
    }
    if (l.back().item != 9) {
      System.out.println("back.item is wrong.");
    }

    l.insertAfter(10, l.head.next);
    System.out.println("\nInserting 10 after 9.\nList with 10 is " + l);
    if (l.head.next.item != 9) {
      System.out.println("head.next.item is wrong.");
    }
    if (l.head.next.prev != l.head) {
    ...
    if (l.next(l.head.next).item != 10) {
      System.out.println("l.next is wrong.");
    }
    if (l.prev(l.head.prev).item != 9) {
      System.out.println("l.prev is wrong.");
    }
  }
}