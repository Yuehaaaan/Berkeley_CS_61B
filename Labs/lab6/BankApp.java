  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      try {
          ...
          System.err.println("Hahahaha " + e4);
      } catch(BadAccountException e3) {
          System.err.println("Catch an BadAccountException" + e3);      
      } catch(IOException e) {
	        System.err.println("Catch an IOException: " + e);
      }
      try {
        command = bankApp.readLine("--> ");
      } catch (IOException e2) {
        System.err.println("Catch an IOException: " + e2);
      }
      }
    } catch (IOException e1) {
        System.err.println("Catch an IOException: " + e1);
    }
  }
